  ...
  return (
    ...
    >
      <section className="flex flex-col gap-y-1">
        <h3 className="text-5 font-bold">{reward}</h3>
        <p className="text-5 font-medium text-primary-1">
      ...
      >
        <span className="text-1 font-bold">{stock.toLocaleString()}</span>
      ...
      <button
        ...
        } text-white text-5 font-bold rounded-full`}
        disabled={outOfStock}
      >
